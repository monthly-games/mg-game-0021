...
Cleaner brigade action game

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Pollution Zero: Cleaner Brigade gameplay screen](docs/images/gameplay-showcase.png)

**Pollution Zero: Cleaner Brigade** centers on the **Build and Survive** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0021.git
